const cardObjectDefinitions = [
 {id:1, imagePath:'RWS_Tarot_04_Emperor.jpg'},
    {id:2, imagePath:'./magician.jpg'},  
    {id:3, imagePath:'./wand.jpg'},
    {id:4, imagePath:'./sun.jpg'}
]
const aceId = 4

const cardBackImgPath = './pngtree-mystical-bohemian-tarot-card-with-moon-decorative-image_779769.jpg'
...
function shuffleCards()
{
    ...
    function shuffle()
    {
        ...
        if(shuffleCount == 500)
        {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, "Please click the card that you think is The Sun Card...")
